...
def print_messages():
   ...
   # iterate robots
   for robot, robot_messages in messages.items():
      print(robot) 
      # iterate messages of a robot
      for message in robot_messages:
         # message attribute of timestamp and data
         print('\t', message['timestamp'])
         # iterate each item in a message table
         for data in message['data']:
            print('\t\t', data)

def print_optitrack_data(robot_name):
   target_robot = None
