...
Vector3 goal_locs[N_ROBOTS] = {
	...
	//5
	Vector3(-dis*4, 0, 0),
	Vector3(-dis*4 - dis/3, -dis, 0),
	Vector3(-dis*4 - dis/3, dis, 0),

	//2-1 
	Vector3(-dis*5, 0, 0),
	Vector3(-dis*5 - dis/3, -dis, 0),
	Vector3(-dis*5 - dis/3, dis, 0),

	//2-2 
	Vector3(-dis*6, 0, 0),
	Vector3(-dis*6 - dis/3, -dis, 0),
	Vector3(-dis*6 - dis/3, dis, 0),

	//2-3 
	Vector3(-dis*7, 0, 0),
	Vector3(-dis*7 - dis/3, -dis, 0),
	Vector3(-dis*7 - dis/3, dis, 0),

	//2-4 
	Vector3(-dis*8, 0, 0),
	Vector3(-dis*8 - dis/3, -dis, 0),
	Vector3(-dis*8 - dis/3, dis, 0),

	//2-5 
	Vector3(-dis*9, 0, 0),
	Vector3(-dis*9 - dis/3, -dis, 0),
	Vector3(-dis*9 - dis/3, dis, 0),

	//3-1 
	Vector3(-dis*10, 0, 0),
	Vector3(-dis*10 - dis/3, -dis, 0),
	Vector3(-dis*10 - dis/3, dis, 0),

	//3-2 
	Vector3(-dis*11, 0, 0),
	Vector3(-dis*11 - dis/3, -dis, 0),
	Vector3(-dis*11 - dis/3, dis, 0),

	//3-3 
	Vector3(-dis*12, 0, 0),
	Vector3(-dis*12 - dis/3, -dis, 0),
	Vector3(-dis*12 - dis/3, dis, 0),

	//3-4 
	Vector3(-dis*13, 0, 0),
	Vector3(-dis*13 - dis/3, -dis, 0),
	Vector3(-dis*13 - dis/3, dis, 0),
