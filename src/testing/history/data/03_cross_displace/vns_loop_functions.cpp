...
if (DISPLACE == 1) {
         ...
         for(SPiPuck& s_pipuck : m_vecPiPucks) {
            if (s_pipuck.Entity->GetId() == robot_name.str()) {
               ...
               while (flag == false) {
                  ...
                  distance = (s_pipuck.Entity->GetEmbodiedEntity().GetOriginAnchor().Position - 
   ...
   REGISTER_LOOP_FUNCTIONS(CVNSLoopFunctions, "vns_loop_functions_03_cross_displace");
