...
function step()
	...
	--api.move(vector3(0, 0, 0), vector3(0,0,0))  -- move along a circle diameter 1m in 100s
	--api.move(vector3(0.1, 0.1, 0), vector3(0,0,0))  -- move along a circle diameter 1m in 100s
