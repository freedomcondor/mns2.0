...
package.path = package.path .. ";C:/Users/rosha/OneDrive/Desktop/Weixu/mns2.0/build/testing/exp_03_1_obstacle_avoidance_small_hor/?.lua"
...
function reset()
	...
	{ type = "sequence", children = {
		...
		vns.Driver.create_driver_node(vns, {waiting = waiting_flag}),
	}}
end
