...
{ 	robotTypeS = "drone",
    ...
    {	robotTypeS = "pipuck",
        ...
        children = {
        {	robotTypeS = "pipuck",
            positionV3 = vector3(pipuckDis*0.7 - (-pipuckDis*0.3), 0, -height),
            orientationQ = quaternion(0, vector3(0,0,1)),
        },
        {	robotTypeS = "pipuck",
            positionV3 = vector3(-pipuckDis*0.3 - (-pipuckDis*0.3), pipuckDis, -height),
            orientationQ = quaternion(0, vector3(0,0,1)),
        },
    }},
    ...
    { 	robotTypeS = "drone",
        ...
        children = {
            {	robotTypeS = "pipuck",
                positionV3 = vector3(pipuckDis*0.7, 0, -height),
                orientationQ = quaternion(0, vector3(0,0,1)),
            },
            {	robotTypeS = "pipuck",
                positionV3 = vector3(-pipuckDis*0.3, 0, -height),
