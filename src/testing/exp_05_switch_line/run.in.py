...
obstacle_locations = generate_line_locations(10,               # number of obstacles
                                              -3.5, 2.5,        # begin x and y
                                              1.0, 1.0)         # end x and y
obstacle_locations2 = generate_line_locations(10,               # number of obstacles
                                              -3.5, -2.5,       # begin x and y
                                              1.0, -1.0)        # end x and y
obstacle_locations3 = generate_line_locations(4,               # number of obstacles
                                              -3, 0,       # begin x and y
                                              2, 0)        # end x and y
...
obstacle_xml2 = generate_obstacles(obstacle_locations3, 150, 101) # start id and payload
