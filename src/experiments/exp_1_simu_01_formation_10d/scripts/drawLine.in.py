...
# two subfigures
fig, axs = plt.subplots(2, 2, gridspec_kw={'width_ratios': [5, 1], 'height_ratios': [1, 10]})
fig.subplots_adjust(hspace=0.05)  # adjust space between axes
axs[0,0].axis('off')
axs[0,1].set_ylim([5.21, 5.5])
axs[0,1].yaxis.set_ticks([5.30, 5.5])

axs[1,0].set_ylim([-0.2, 2.70])
axs[1,1].set_ylim([-0.2, 2.70])
