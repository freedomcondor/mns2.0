...
DATADIR=@CMAKE_SOURCE_DIR@/../../mns2.0-data/src/experiments/exp_1_simu_01_formation_10d/data_simu/data
#DATADIR=@CMAKE_SOURCE_DIR@/../../mns2.0-data/src/experiments/exp_1_simu_01_formation_10d/data_simu/test
TMPDIR=threads
