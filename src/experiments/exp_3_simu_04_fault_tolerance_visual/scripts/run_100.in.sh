...
DATADIR=@CMAKE_SOURCE_DIR@/../../mns2.0-data/src/experiments/exp_3_simu_04_fault_tolerance_visual/data_simu_0.5s/data
#DATADIR=@CMAKE_SOURCE_DIR@/../../mns2.0-data/src/experiments/exp_3_simu_04_fault_tolerance_visual/data_simu_1s/data
#DATADIR=@CMAKE_SOURCE_DIR@/../../mns2.0-data/src/experiments/exp_3_simu_04_fault_tolerance_visual/data_simu_30s/data
