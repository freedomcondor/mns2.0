...
obstacle_locations1 = generate_line_locations(10,               # number of obstacles
...
obstacle_xml = generate_obstacles(obstacle_locations1, 100, 34) # start id and payload
obstacle_xml += generate_obstacles(obstacle_locations2, 200, 35) # start id and payload
