...
DATADIR=@CMAKE_SOURCE_DIR@/../../mns2.0-data/src/experiments/exp_1_simu_10_formation_10d_group_start/data_simu/data
#DATADIR=@CMAKE_SOURCE_DIR@/../../mns2.0-data/src/experiments/exp_1_simu_10_formation_10d_group_start/data_simu/test
TMPDIR=threads
