...
logReader.calcSegmentData(robotsData, geneIndex, stage2Step, stage1000 - 1)
logReader.calcSegmentData(robotsData, geneIndex, stage1000, stage3Step - 1)
...
logReader.calcSegmentLowerBound(robotsData, geneIndex, lowerBoundParameters, stage2Step, stage1000 - 1)
logReader.calcSegmentLowerBound(robotsData, geneIndex, lowerBoundParameters, stage1000, stage3Step - 1)
