...
for i in range(1, test_number + 1):
	...
	os.system(testfolder_build + "/evaluator/main_04_cross_displace_drone " + str(jump) + " ./")
	os.system("mv result.txt " + testfolder_src + "/random/run" + str(i) + "/result1.txt")
	os.system(testfolder_build + "/evaluator/main_04_cross_displace_drone " + str(total_length) + " ./")
