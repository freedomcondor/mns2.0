...
for i in range(test_start, test_end + 1):
	...
	os.system(testfolder_build + "/evaluator/main_02_displace_mns_drone " + str(jump) + " ./")
	os.system("mv result.txt " + testfolder_src + "/random/run" + str(i) + "/result1.txt")
	os.system(testfolder_build + "/evaluator/main_02_displace_mns_drone " + str(total_length) + " ./")
